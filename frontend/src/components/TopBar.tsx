...
const TopBar = () => {
  ...
  // If the user clicks close, we return null to remove the component from the DOM
  ...
  return (
    <div className='bg-[#3d2b1f] text-white text-[10px] sm:text-xs py-2 px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] transition-all duration-500'>
      <div className='flex justify-between items-center w-full relative'>
        ...
        {/* Left Side: Support (Hidden on very small screens to save space) */}
        ...
        {/* Mobile View: Promo (Condensed) */}
        <p className='sm:hidden font-medium flex-1 text-center'>
            25% OFF <span onClick={() => navigate('/login')} className='underline ml-1'>JOIN</span>
        </p>
